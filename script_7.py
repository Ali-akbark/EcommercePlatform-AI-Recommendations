# Create the recommendation engine notebook
recommendation_notebook = """# Databricks notebook source
# MAGIC %md
...
# Write the recommendation engine notebook
with open(f"{project_name}/notebooks/04_recommendation_engine.py", "w", encoding="utf-8") as f:
    f.write(recommendation_notebook)

print("✅ Created recommendation engine notebook (04_recommendation_engine.py)")
print("📄 Length:", len(recommendation_notebook), "characters")
print("🤖 Features: ALS collaborative filtering, content-based filtering, customer segmentation, hybrid approach, A/B testing")